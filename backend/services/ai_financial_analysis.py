...
def get_default_analysis(language: str = 'es') -> Dict:
    ...
    defaults = {
        ...
        'en': {
            ...
            "income_flow_analysis": "The income statement flow shows how revenue is converted to net profit. It is important to analyze cost of sales and operating expenses proportions to identify margin improvement opportunities.",
        ...
        'pt': {
            ...
            "income_flow_analysis": "O fluxo da demonstração de resultados mostra como a receita é convertida em lucro líquido. É importante analisar as proporções de custo de vendas e despesas operacionais para identificar oportunidades de melhoria de margens.",
