...
const ScoreColor = (score) => {
  if (score >= 85) return { bg: 'bg-emerald-500', text: 'text-emerald-600', light: 'bg-emerald-50 border-emerald-200' };
  if (score >= 60) return { bg: 'bg-yellow-400', text: 'text-yellow-600', light: 'bg-yellow-50 border-yellow-200' };
  return { bg: 'bg-red-500', text: 'text-red-600', light: 'bg-red-50 border-red-200' };
};
        ...
        <div className="flex items-center justify-between">
          <div>
            <p className="text-xs text-[#00C9A7] font-semibold uppercase tracking-widest mb-1">
              TaxnFin · Inteligencia Financiera
            </p>
            <h1 className="text-xl font-bold text-white" style={{ fontFamily: 'Manrope' }}>
              Simulador de Financiamiento
            </h1>
            <p className="text-sm text-slate-400 mt-0.5">
              Evalúa el impacto de un crédito en tu Cash Flow real
            </p>
          </div>
          <DollarSign className="h-8 w-8 text-[#00C9A7] opacity-60" />
        </div>
      </div>
            ...
            <>
              ...
              {resultado.analisis_ia && (
                <Card className="border-violet-200 bg-violet-50">
                  ...
                  <CardContent>
                    <p className="text-sm text-slate-700 leading-relaxed">{resultado.analisis_ia}</p>
                  </CardContent>
                </Card>
              )}
